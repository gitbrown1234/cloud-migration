...
parser.add_argument('-sourcetypeRenaming',
                    ...
                    action='store_true')
parser.add_argument('-sourcetypes',
                    help='(optional) migrate sourcetype definitions (props.conf stanzas)', 
                    action='store_true')
...
def sourcetypes(app, destApp, destOwner, noPrivate, noDisabled, includeEntities,
                excludeEntities, includeOwner, excludeOwner, privateOnly,
                override, overrideAlways, actionResults):
...
if args.sourcetypes:
    logger.info("Begin sourcetypes transfer")
    sourcetypesResults = {}
    if src_app_list:
        for current_src_app in src_app_list:
            sourcetypes(
                ...
                args.noDisabled, includeEntities, excludeEntities, includeOwner,
                excludeOwner, args.privateOnly, args.overrideMode,
                args.overrideAlwaysMode, sourcetypesResults
            )
    else:
        sourcetypes(
            srcApp, destApp, destOwner, args.noPrivate, args.noDisabled,
    ...
    logger.info("End sourcetypes transfer")
...
logDeletion(sourcetypesResults, args.printPasswords, destUsername, destPassword)
...
handleFailureLogging(sourcetypesResults, "sourcetypes", srcApp)
...
logStats(sourcetypesResults, "sourcetypes", srcApp)
